    ...
    return (
        ...
        >
            ...
            <div className="text-center pb-10 ">
                <input className="w-[35%] py-3 px-10 border font-bold rounded-lg" type="text" placeholder="searching....." />{" "}
                <button className="bg-red-500 py-3 px-10 font-bold text-white rounded-lg">Search</button>
            </div>
            <div></div>
        </div>
    );
